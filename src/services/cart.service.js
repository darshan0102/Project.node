...
module.exports = class cartServices {
    async addToCart(body) {
        try {
            ...
            console.log(error);
            return res.json({ message: "services error while addding in to cart" });
        }
    };
    ...
    async getCartById(id) {
        try {
            ...
            console.log(error);
            return res.json({ message: "services error while getting in to cart bu ID" });
        }
    };
    ...
    async updateCart(id, body) {
        try {
            ...
            console.log(error);
            return res.json({ message: "ervices error while updaing in to cart" })
        }
    };
    ...
    async updatemanyCart(user, body) {
        try {
            ...
            console.log(error);
            return res.json({ message: "ervices error while updating in to cart" });
        }
    };
};